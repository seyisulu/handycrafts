...
-- Dumping structure for table faktest.tax_lga
CREATE TABLE IF NOT EXISTS `tax_lga` (
  `id` int(10) NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `state_id` int(10) NOT NULL COMMENT 'State',
  `local_govt` text NOT NULL COMMENT 'LGA Name',
  PRIMARY KEY (`id`),
  KEY `state_id` (`state_id`)
) ENGINE=InnoDB AUTO_INCREMENT=775 DEFAULT CHARSET=utf32 ROW_FORMAT=COMPACT COMMENT='Local Government Areas in Nigeria.';

-- Dumping data for table faktest.tax_lga: ~774 rows (approximately)
/*!40000 ALTER TABLE `tax_lga` DISABLE KEYS */;
REPLACE INTO `tax_lga` (`id`, `state_id`, `local_govt`) VALUES
	(1, 1, 'Aba North'),
	(2, 1, 'Aba South'),
	(3, 1, 'Arochukwu'),
	(4, 1, 'Bende'),
	...
	(773, 37, 'Chafe'),
	(774, 37, 'Zurmi');
/*!40000 ALTER TABLE `tax_lga` ENABLE KEYS */;
